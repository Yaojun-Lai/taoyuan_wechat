...
Page({
  data: {
    ...
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/19.png',
    'index': 'bird0'},
   {'name': '灰鹅',
    'text': '线索二：翅膀颜色脏脏的，不是白色也不是黑色。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/53.png',
    'index': 'bird1'},
   {'name': '灰鹅',
    'text': '线索三：这黄黄短短的脚蹼，真的能游得快么？',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/87.png',
    'index': 'bird2'},
   {'name': '中华秋沙鸭',
    'text': '线索一：长相十分潦草，像出门没梳头一样。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/23.png',
    'index': 'bird3'},
   {'name': '中华秋沙鸭',
    'text': '线索二：全身羽毛灰白，像个软软的大枕头。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/57.png',
    'index': 'bird4'},
   {'name': '中华秋沙鸭',
    'text': '线索三：翅膀的颜色黑白相间，仿佛穿了一件墨染的花外套',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/91.png',
    'index': 'bird5'},
   {'name': '中华秋沙鸭',
    'text': '线索四：一看就会游泳！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/159.png',
    'index': 'bird6'},
   {'name': '中华秋沙鸭',
    'text': '线索四：一看就会游泳！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/125.png',
    'index': 'bird7'},
   {'name': '鸳鸯',
    'text': '线索一：嘴巴红红，眼睛圆圆，羽毛的颜色却很丰富',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/25.png',
    'index': 'bird8'},
   {'name': '鸳鸯',
    'text': '线索二：这种鸟儿经常被绣在手帕上，光是绣身体就得用三种颜色的丝线。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/59.png',
    'index': 'bird9'},
   {'name': '鸳鸯',
    'text': '线索三：我捡到了一片它的翅羽，黄灿灿的，真好看！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/93.png',
    'index': 'bird10'},
   {'name': '鸳鸯',
    'text': '线索四：它蹬着脚蹼游来游去的样子，我看了整整一下午。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/127.png',
    'index': 'bird11'},
   {'name': '鸳鸯',
    'text': '线索五：它在水中嬉戏玩耍，翅膀的颜色像夕阳一样！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/161.png',
    'index': 'bird12'},
   {'name': '白鹭',
    'text': '线索一：它的脑袋后面有根细长的白色羽毛，像小辫子一样',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/27.png',
    'index': 'bird13'},
   {'name': '白鹭',
    'text': '线索二：它的脑袋后面有根细长的白色羽毛，像小辫子一样',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/61.png',
    'index': 'bird14'},
   {'name': '白鹭',
    'text': '线索三：全身只有脚和嘴的颜色一样。是马大卫上次说的那只蓝嘴鸟吗？',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/95.png',
    'index': 'bird15'},
   {'name': '丹顶鹤',
    'text': '线索一：它，它的嘴尖尖的，嘴的颜色和头顶的颜色相近。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/29.png',
    'index': 'bird16'},
   {'name': '丹顶鹤',
    'text': '线索二：它，它的嘴尖尖的，嘴的颜色和头顶的颜色相近。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/63.png',
    'index': 'bird17'},
   {'name': '丹顶鹤',
    'text': '线索三：黑白相间的羽毛，怎么看都像是蘸了墨汁儿。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/97.png',
    'index': 'bird18'},
   {'name': '丹顶鹤',
    'text': '线索四：它墨色的脚细而长，端站时透着一股清冷气息。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/131.png',
    'index': 'bird19'},
   {'name': '丹顶鹤',
    'text': '线索五：它还会飞！翅膀展开时，像一张被墨色渲染半边的白纸。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/165.png',
    'index': 'bird20'},
   {'name': '白琵鹭',
    'text': '线索一：这只鸟儿的嘴巴长长的，扁扁的，好像一把琵琶！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/31.png',
    'index': 'bird21'},
   {'name': '白琵鹭',
    'text': '线索二：鹅黄的羽毛，浑圆的背部，看起来像一块和田玉。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/65.png',
    'index': 'bird22'},
   {'name': '白琵鹭',
    'text': '线索三：浑身上下羽毛都是一个颜色，翅膀敛起来的时候好矜持的样子。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/99.png',
    'index': 'bird23'},
   {'name': '白琵鹭',
    'text': '线索四：它的脚黑黑的，我本来还以为它的脚丫子也是黄色的呢，哎！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/133.png',
    'index': 'bird24'},
   {'name': '白琵鹭',
    'text': '线索五：飞过的时候我捡到了一片儿它翅膀上的羽毛，淡淡的黄色真好看。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/167.png',
    'index': 'bird25'},
   {'name': '朱鹭',
    'text': '线索一：头顶红红，嘴巴黑黑，好像...还有粉粉的冠羽？',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/33.png',
    'index': 'bird26'},
   {'name': '朱鹭',
    'text': '线索二：它的上半身白白粉粉的，到尾部红色越来越深。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/67.png',
    'index': 'bird27'},
   {'name': '朱鹭',
    'text': '线索三：它的翅羽粉色略深，羽毛翘起的样子也很可爱。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/101.png',
    'index': 'bird28'},
   {'name': '朱鹭',
    'text': '线索四：虽然也是红红的脚爪，但它的脚爪可比小鸭子们细长多啦！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/135.png',
    'index': 'bird29'},
   {'name': '朱鹭',
    'text': '线索五：粉翅膀从我头顶掠过。粉红也是红！"红"运当头，我要走好运了？！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/169.png',
    'index': 'bird30'},
   {'name': '麻雀',
    'text': '线索一：脑袋像个泥团子，很可爱。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/189.png',
    'index': 'bird31'},
   {'name': '麻雀',
    'text': '线索二：圆滚滚的身体，一定吃了很多东西。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/223.png',
    'index': 'bird32'},
   {'name': '麻雀',
    'text': '线索三：翅膀灰灰的，也像个泥团子。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/257.png',
    'index': 'bird33'},
   {'name': '麻雀',
    'text': '线索四：好短的脚！走起路来，蹦蹦跳跳的！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/291.png',
    'index': 'bird34'},
   {'name': '麻雀',
    'text': '线索五：它扑棱着灰色的小翅膀从我头顶飞过，好可爱啊！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/325.png',
    'index': 'bird35'},
   {'name': '虎皮鹦鹉',
    'text': '线索一：眼睛圆圆的，透着天真与可爱。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/191.png',
    'index': 'bird36'},
   {'name': '虎皮鹦鹉',
    'text': '线索二：这颜色，躲在草丛一定很难被发现吧！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/225.png',
    'index': 'bird37'},
   {'name': '虎皮鹦鹉',
    'text': '线索三：翅膀上的花纹一条一条的，像老虎的花纹一样！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/259.png',
    'index': 'bird38'},
   {'name': '虎皮鹦鹉',
    'text': '线索四：爪子黄黄的！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/293.png',
    'index': 'bird39'},
   {'name': '虎皮鹦鹉',
    'text': '线索五：我以为飘落脚边的是一片翠竹叶，没想到是它的翅羽！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/327.png',
    'index': 'bird40'},
   {'name': '斑鸠',
    'text': '线索一：它没有又细又长的嘴巴。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/193.png',
    'index': 'bird41'},
   {'name': '斑鸠',
    'text': '线索二：它的尾羽颜色简单，样式朴素，看上去并不华丽。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/227.png',
    'index': 'bird42'},
   {'name': '斑鸠',
    'text': '线索三：粽灰色的翅膀圆圆胖胖，平时应该吃得挺好的！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/261.png',
    'index': 'bird43'},
   {'name': '斑鸠',
    'text': '线索四：它的脚不长也不短，不黑也不蓝。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/295.png',
    'index': 'bird44'},
   {'name': '斑鸠',
    'text': '线索五：它咕咕叫着跑来跑去，结果摔了一跤，掉下去一片粽灰色的羽毛。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/329.png',
    'index': 'bird45'},
   {'name': '戴胜',
    'text': '线索一：今天看到了一只鸟，脑袋长得像把扇子！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/195.png',
    'index': 'bird46'},
   {'name': '戴胜',
    'text': '线索二：它长着黄色浑圆的身子和漂亮的花尾羽。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/229.png',
    'index': 'bird47'},
   {'name': '戴胜',
    'text': '线索三：翅膀上的羽毛有条纹，还挺好看的！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/263.png',
    'index': 'bird48'},
   {'name': '戴胜',
    'text': '线索四：它没有细细长长的脚。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/297.png',
    'index': 'bird49'},
   {'name': '戴胜',
    'text': '线索五：它飞走时落下一片羽毛，色彩花纹都很特别！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/331.png',
    'index': 'bird50'},
   {'name': '竹鹧鸪',
    'text': '线索一：别的鸟儿都有好看的小帽子，只有它没有。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/197.png',
    'index': 'bird51'},
   {'name': '竹鹧鸪',
    'text': '线索二：泥土色的羽毛不华丽，却自有朴素之美。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/231.png',
    'index': 'bird52'},
   {'name': '竹鹧鸪',
    'text': '线索三：通过脚来看，它应该不会游泳。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/265.png',
    'index': 'bird53'},
   {'name': '绿原鸡',
    'text': '线索一：头戴红冠，像个雄赳赳气昂昂的将军。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/199.png',
    'index': 'bird54'},
   {'name': '绿原鸡',
    'text': '线索二：墨绿色的身体，高高翘起的尾羽，让它看上去十分有气势。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/233.png',
    'index': 'bird55'},
   {'name': '绿原鸡',
    'text': '线索三：浑身上下颜色相同，翅膀也是墨绿墨绿的。！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/267.png',
    'index': 'bird56'},
   {'name': '绿原鸡',
    'text': '线索四：它的脚不够细长，不能站在水中，也没有脚蹼，应该不会游泳。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/301.png',
    'index': 'bird57'},
   {'name': '绿原鸡',
    'text': '线索五：我捡了好几片它的羽毛，准备拿来做个墨绿色的毽子！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/335.png',
    'index': 'bird58'},
   {'name': '勺鸡',
    'text': '线索一：羽冠挺立，看上去非常有精神！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/201.png',
    'index': 'bird59'},
   {'name': '勺鸡',
    'text': '线索二：虽然羽毛的颜色朴素，前胸却有一抹鲜亮的红色。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/235.png',
    'index': 'bird60'},
   {'name': '勺鸡',
    'text': '线索三：它的翅膀上没有白色，也没有黑色！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/269.png',
    'index': 'bird61'},
   {'name': '勺鸡',
    'text': '线索四：一看就不会游泳！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/303.png',
    'index': 'bird62'},
   {'name': '勺鸡',
    'text': '线索五：它的翅膀像一件棕色的蓑衣！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/337.png',
    'index': 'bird63'},
   {'name': '红腹锦鸡',
    'text': '线索一：头戴金丝冠，像画本子上描述的小皇子一样！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/203.png',
    'index': 'bird64'},
   {'name': '红腹锦鸡',
    'text': '线索二：腹羽深红，尾羽又长又绚丽！好好看！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/237.png',
    'index': 'bird65'},
   {'name': '红腹锦鸡',
    'text': '线索三：翅膀的颜色也很绚丽，有红色，还有蓝色！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/271.png',
    'index': 'bird66'},
   {'name': '红腹锦鸡',
    'text': '线索四：它的爪子黄黄的，和羽冠的颜色差不多！',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/305.png',
    'index': 'bird67'},
   {'name': '红腹锦鸡',
    'text': '线索五：全红的翅膀色彩绚丽，翱翔蓝天之上，仿佛旭日东升。',
    'avatar': 'https://gitee.com/Yaojun-Lai/images_needed/raw/master/339.png',
    'index': 'bird68'}]
