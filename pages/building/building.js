...
Page({
  data: {
    ...
    allFoods: [{'index': 'build16', 'name': '风吹萝动', 'character': '萝哐哐', 'comfort': 240, 'material': '29楠木＋32铁＋31桐油', 'avatar': '', 'price': '165000', 'job': '鲁公神鱼'},
    {'index': 'build17', 'name': '鹅有点累', 'character': '萝叮叮', 'comfort': 235, 'material': '35楠木＋35铁＋33桐油', 'avatar': '', 'price': '154000', 'job': '鲁公神鱼'},
    {'index': 'build18', 'name': '捻香花浴', 'character': '萝香五', 'comfort': 230, 'material': '34楠木＋32铁＋34桐油', 'avatar': '', 'price': '143000', 'job': '制香'},
    {'index': 'build19', 'name': '一跃登天', 'character': '萝小杵', 'comfort': 225, 'material': '31楠木＋33铁＋33桐油', 'avatar': '', 'price': '132000', 'job': '水磨坊'},
    {'index': 'build20', 'name': '荷香闲垂', 'character': '萝一味', 'comfort': 220, 'material': '32楠木＋31铁＋29桐油', 'avatar': '', 'price': '121000', 'job': '养生坊'},
    {'index': 'build21', 'name': '紫藤心事', 'character': '萝小花', 'comfort': 215, 'material': '30楠木＋28铁＋31桐油', 'avatar': '', 'price': '110000', 'job': '纺织'},
    {'index': 'build22', 'name': '弦柱萝音', 'character': '萝霜霜', 'comfort': 210, 'material': '27楠木＋30铁＋29桐油', 'avatar': '', 'price': '99000', 'job': '养颜坊'},
    {'index': 'build23', 'name': '柿柿如意', 'character': '萝小晾', 'comfort': 205, 'material': '28楠木＋28铁＋26桐油', 'avatar': '', 'price': '88000', 'job': '晾晒'},
    {'index': 'build24', 'name': '铁环滚滚', 'character': '萝咩咩', 'comfort': 200, 'material': '27楠木＋25铁＋27桐油', 'avatar': '', 'price': '77000', 'job': '羊圈'},
    {'index': 'build25', 'name': '枫月萝韵', 'character': '萝小臼', 'comfort': 195, 'material': '24楠木＋26铁＋26桐油', 'avatar': '', 'price': '66000', 'job': '水磨坊'},
    {'index': 'build26', 'name': '小萝飞镖', 'character': '萝小毫', 'comfort': 190, 'material': '25楠木＋24铁＋22桐油', 'avatar': '', 'price': '55000', 'job': '文具'},
    {'index': 'build27', 'name': '沧海萝珠', 'character': '萝鱼干', 'comfort': 185, 'material': '23楠木＋21铁＋24桐油', 'avatar': '', 'price': '44000', 'job': '水晒坊'},
    {'index': 'build28', 'name': '萝趣风车', 'character': '萝小糕', 'comfort': 180, 'material': '20楠木＋23铁＋22桐油', 'avatar': '', 'price': '39600', 'job': '糕坊'},
    {'index': 'build29', 'name': '萝舞鱼龙', 'character': '萝贝红', 'comfort': 175, 'material': '22楠木＋21铁＋19桐油', 'avatar': '', 'price': '36300', 'job': '养殖区'},
    {'index': 'build30', 'name': '八卦趣谈', 'character': '萝红土', 'comfort': 170, 'material': '20楠木＋18铁＋20桐油', 'avatar': '', 'price': '33000', 'job': '息壤'},
    {'index': 'build31', 'name': '萝萝套圈', 'character': '萝小虎', 'comfort': 165, 'material': '16楠木＋19铁＋18桐油', 'avatar': '', 'price': '31350', 'job': '玩具'},
    {'index': 'build32', 'name': '布偶戏台', 'character': '萝小竹', 'comfort': 160, 'material': '18楠木＋17铁＋15桐油', 'avatar': '', 'price': '28050', 'job': '竹林'},
    {'index': 'build33', 'name': '萝鼓达人', 'character': '萝大巧', 'comfort': 155, 'material': '17楠木＋15铁＋17桐油', 'avatar': '', 'price': '24750', 'job': '编织'},
    {'index': 'build34', 'name': '萝骑竹马', 'character': '萝黄土', 'comfort': 150, 'material': '14楠木＋17铁＋16桐油', 'avatar': '', 'price': '21450', 'job': '息壤'},
    {'index': 'build35', 'name': '弹弓冲击', 'character': '萝小陶', 'comfort': 145, 'material': '17楠木＋16铁＋14桐油', 'avatar': '', 'price': '18150', 'job': '陶瓷'},
    {'index': 'build36', 'name': '跷跷板萝', 'character': '萝小腐', 'comfort': 140, 'material': '15楠木＋13铁＋16桐油', 'avatar': '', 'price': '16500', 'job': '豆腐加工'},
    {'index': 'build37', 'name': '萝萝斗鸡', 'character': '萝黑土', 'comfort': 135, 'material': '12楠木＋15铁＋14桐油', 'avatar': '', 'price': '14850', 'job': '息壤'},
    {'index': 'build38', 'name': '蛟萝入水', 'character': '萝不土', 'comfort': 130, 'material': '13楠木＋13铁＋11桐油', 'avatar': '', 'price': '13200', 'job': '土料'},
    {'index': 'build6', 'name': '腕力比拼', 'character': '萝大腐', 'comfort': 125, 'material': '11楠木＋9铁＋12桐油', 'avatar': '', 'price': '11550', 'job': '豆腐加工'},
    {'index': 'build1', 'name': '盆栽小桌', 'character': '萝大林', 'comfort': 120, 'material': '9楠木＋11铁＋11桐油', 'avatar': '', 'price': '9900', 'job': '伐木林'},
    {'index': 'build3', 'name': '泥萝筑城', 'character': '萝小缸', 'comfort': 115, 'material': '9楠木＋9铁＋7桐油', 'avatar': '', 'price': '8800', 'job': '腌制'},
    {'index': 'build4', 'name': '头绳舞台', 'character': '萝如意', 'comfort': 110, 'material': '7楠木＋5铁＋7桐油', 'avatar': '', 'price': '7700', 'job': '蒲公英'},
    {'index': 'build2', 'name': '悠悠吊床', 'character': '萝小巧', 'comfort': 105, 'material': '3楠木＋6铁＋5桐油', 'avatar': '', 'price': '6600', 'job': '木工'},
    {'index': 'build7', 'name': '小萝相扑', 'character': '萝小木', 'comfort': 100, 'material': '5楠木＋4铁＋2桐油', 'avatar': '', 'price': '5500', 'job': '伐木林'},
    {'index': 'build9', 'name': '坐井观萝', 'character': '萝小馒', 'comfort': 95, 'material': '4楠木＋2铁＋4桐油', 'avatar': '', 'price': '4400', 'job': '饼坊'},
    {'index': 'build10', 'name': '葫芦藤架', 'character': '萝吉祥', 'comfort': 90, 'material': '1楠木＋4铁＋3桐油', 'avatar': '', 'price': '3300', 'job': '蒲公英'},
    {'index': 'build0', 'name': '武林高萝', 'character': '萝小糖', 'comfort': 85, 'material': '2楠木＋1铁＋2桐油', 'avatar': '', 'price': '2750', 'job': '制糖'},
    {'index': 'build15', 'name': '萝卜墩墩', 'character': '萝小旦', 'comfort': 80, 'material': '2楠木＋2铁＋1桐油', 'avatar': '', 'price': '1980', 'job': '鸡舍'},
    {'index': 'build11', 'name': '萝萝走秀', 'character': '萝木七', 'comfort': 75, 'material': '1楠木＋1铁＋2桐油', 'avatar': '', 'price': '1650', 'job': '造建筑'},
    {'index': 'build13', 'name': '光阴日晷', 'character': '萝小满', 'comfort': 70, 'material': '1楠木＋2铁＋1桐油', 'avatar': '', 'price': '1320', 'job': '种地'},
    {'index': 'build14', 'name': '喵财进宝', 'character': '萝万三', 'comfort': 65, 'material': '2楠木＋1铁＋1桐油', 'avatar': '', 'price': '1650', 'job': '驿站'},
    {'index': 'build12', 'name': '萝切水果', 'character': '萝小刀', 'comfort': 60, 'material': '1楠木＋2铁', 'avatar': '', 'price': '990', 'job': '铡刀'},
    {'index': 'build5', 'name': '吱呀秋千', 'character': '萝小磨', 'comfort': 55, 'material': '1楠木＋1铁', 'avatar': '', 'price': '880', 'job': '石磨坊'},
    {'index': 'build8', 'name': '掷箭投壶', 'character': '萝小豆', 'comfort': 50, 'material': '1楠木', 'avatar': '', 'price': '770', 'job': '豆坊'}]
